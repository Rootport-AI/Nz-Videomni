...
- `S:\OriginalApps\12_Nz-LTX23-AviUtl2\Nz-LTX23-frontend-AviUtl2\aviutl2_sdk\aviutl2_plugin_sdk.txt`(SDK総論・更新履歴全文)
- `S:\OriginalApps\12_Nz-LTX23-AviUtl2\Nz-LTX23-frontend-AviUtl2\aviutl2_sdk\plugin2.h`(`COMMON_PLUGIN_TABLE:46` / `EDIT_INFO:131` / `EDIT_SECTION:154` / `create_object_from_media_file:289` / `EDIT_HANDLE:580` / `call_edit_section_param:592` / `get_edit_info:598` / `rendering_scene_video:680` / `wait_rendering_task:696` / `PROJECT_FILE:716` / `HOST_APP_TABLE:755` / `register_window_client:791` / `register_event_listener:914`)
- `S:\OriginalApps\12_Nz-LTX23-AviUtl2\Nz-LTX23-frontend-AviUtl2\aviutl2_sdk\WindowClient.cpp` / `English.WindowClient.aul2`
- `S:\OriginalApps\12_Nz-LTX23-AviUtl2\Nz-LTX23-frontend-AviUtl2\aviutl2_sdk\config2.h`(`app_data_path:24`) / `logger2.h` / `cache2.h`
