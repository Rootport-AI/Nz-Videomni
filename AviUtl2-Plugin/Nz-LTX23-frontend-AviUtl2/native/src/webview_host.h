...
//     folder under %LOCALAPPDATA%\NzLTX23\webview2.
//   * Attach a CoreWebView2Controller to the plugin's HWND.
//   * Map the virtual host app.nzltx23.local to the "webui" folder next to the
//     plugin DLL and navigate to https://app.nzltx23.local/index.html.
