...
React + TypeScript + Vite frontend for the Nz-LTX23 AviUtl2 plugin. It's a
...
(`https://app.nzltx23.local/` → `webui/dist/`) and navigates to
`https://app.nzltx23.local/index.html`. Root-absolute asset paths would still
