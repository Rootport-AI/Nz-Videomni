...
// W2 (⬇ insertProvisionalResult): right-clicking a Nz-LTX23 provisional object
 ...
 * (the reservation naming native uses: `NzLTX23#<jobId>`). */
...
describe("App / W2 ⬇ insert this generated result now (insertProvisionalResult)", () => {
  ...
  it(
    "(a) a non-Nz-LTX23 object shows the 'right-click a reservation object' toast and inserts nothing",
    async () => {
      ...
      await screen.findByText(/right-click a nz-ltx23 reservation object/i, undefined, { timeout: 5_000 });
  ...
  it(
    ...
    async () => {
      ...
      emit(bridge, provisionalSelection("NzLTX23#pending-xyz"));
  ...
  it(
    ...
    async () => {
      ...
      emit(bridge, provisionalSelection("NzLTX23#job-done"));
  ...
  it(
    ...
    async () => {
      ...
      emit(bridge, provisionalSelection("NzLTX23#job-run"));
  ...
  it(
    ...
    async () => {
      ...
      emit(bridge, provisionalSelection("NzLTX23#job-fail"));
  ...
  it(
    ...
    async () => {
      ...
      emit(bridge, provisionalSelection("NzLTX23#job-cancel"));
