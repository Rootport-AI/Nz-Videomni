...
export const en = {
   ...
   * "Nz-LTX23" title in the same spot. "LTX 2.3"/"LTX 2.5" are proper nouns —
   ...
   * `Nz-LTX23-backend/gradio_ui/ui.py`'s batch accordion copy (`L("batch_*")`
  ...
  menuInsert: {
    /** W2 (a): the right-clicked object is not a Nz-LTX23 reservation object. */
    notProvisional: "Right-click a Nz-LTX23 reservation object.",
...
export const ja: Strings = {
  ...
  menuInsert: {
    notProvisional: "Nz-LTX23の予約オブジェクトを右クリックしてください。",
...
export const LANG_STORAGE_KEY = "nzltx23.lang";
