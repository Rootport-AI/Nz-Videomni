 ...
 * rate: 24.0` (Nz-LTX23-backend/config.yaml, also engine api_types). Source
 ...
 * (Nz-LTX23-backend/api/errors.py:76-85 `source_video_too_short`). The Chain
 * screen the right-click lands on defaults `context_frames` to
 * `v2v_context_frames_default = 73` (Nz-LTX23-backend/config.py:236, also
 ...
 * (Nz-LTX23-backend/api/generate.py:57-58); there is no up-front frame-count
