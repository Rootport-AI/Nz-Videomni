// timeline_math.h - pure generation-length pre-computation for Nz-Videomni.
//
...
//   Nz-Videomni/chain_math.py   (v_latent_frames / px_from_v_latent /
//                                     compute_chain_layout / a_frames_for_px)
//   Nz-Videomni/api/models.py   (the 8n+1 / range / cap validators)
