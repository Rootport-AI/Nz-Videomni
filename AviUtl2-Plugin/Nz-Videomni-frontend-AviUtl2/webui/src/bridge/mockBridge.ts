...
export function createMockBridge(options: MockBridgeOptions = {}): MockBridge {
  ...
  async function handleDownloadVideo(params: ParamsOf<"backend.downloadVideo">): Promise<ResultOf<"backend.downloadVideo">> {
    ...
    const destDir = params.destDir ?? "C:\\Users\\mock\\AppData\\Local\\Temp\\Nz-Videomni";
  ...
  async function handleCaptureFrame(
    ...
    return {
      filePath: `C:\\Users\\mock\\AppData\\Local\\Temp\\Nz-Videomni\\frame_${frame}_${captureCounter}.png`,
      width,
      height,
      frame,
    };
  ...
  async function handleCutoutRange(
    ...
    const height = options.editInfo?.height ?? DEFAULT_EDIT_INFO.height;
    return {
      filePath: `C:\\Users\\mock\\AppData\\Local\\Temp\\Nz-Videomni\\cutout_${params.layer}_${params.frameStart}_${cutoutCounter}.mp4`,
      width,
      height,
  ...
  async function handleExtractAudio(
    ...
    return {
      filePath: `C:\\Users\\mock\\AppData\\Local\\Temp\\Nz-Videomni\\extract_${params.layer}_${params.frameStart}_${extractCounter}.wav`,
      durationSec,
      sampleRate,
      hasAudioStream: true,
    };
  ...
  async function handleScanProvisionals(): Promise<ResultOf<"timeline.scanProvisionals">> {
    // A faithful scan reports every NzVideomni-tagged object actually on the
