 ...
 * `Nz-Videomni`, lines ~339-396), plus the two small pieces of per-row
 ...
 * `Nz-Videomni`), carries the same fixed key.
 */
...
export interface A2vChainPayload {
   ...
   * = (61, 61)` (`Nz-Videomni`) — one stage-2 tile spanning the whole
