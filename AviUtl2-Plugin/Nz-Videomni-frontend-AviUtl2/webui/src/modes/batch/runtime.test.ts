...
describe("batch A2V runtime", () => {
  ...
  // バックエンドの `Docs/PENDING_TASKS_CLOSED.md` §3-47-02の直接証明（購読者レベル）: Create画面が`key`リマウントされても
  ...
  // バックエンドの `Docs/PENDING_TASKS_CLOSED.md` §3-47-02の直接証明（操作レベル）: 走行中に購読者が入れ替わっても、あとから
