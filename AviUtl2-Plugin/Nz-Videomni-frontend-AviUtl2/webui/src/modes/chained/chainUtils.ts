 ...
 * `Nz-Videomni/chain_math.py`): `(P-1)//8 + 1`, integer division. */
 ...
 * `chain_math.v_tail_latents` (`Nz-Videomni/chain_math.py:349-365`;
 ...
 * `Nz-Videomni/chain_math.py`; see also `Docs/PHASE3_CLIP_CONCAT_STATUS.md`
 ...
 * `Nz-Videomni/gradio_ui/presets.py`): the resolution's
...
// Pure transcriptions of `Nz-Videomni/chain_math.py` (the audio-latent
// geometry single source of truth) and `Nz-Videomni/gradio_ui/handlers.py`
 ...
 *
 * Every `round(...)` in `Nz-Videomni/chain_math.py` is this function, and
