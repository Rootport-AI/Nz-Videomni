...
const MESSAGES = {
  ...
  cropInvalid: "The crop size is larger than the generation size.",
...
describe("GenerateReasonsNote", () => {
  ...
  it("renders one line per reason, in order, as a mild warning banner", () => {
    ...
    expect(items).toEqual(["Fill the main prompt.", "The crop size is larger than the generation size."]);
