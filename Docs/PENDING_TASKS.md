...
| §3-111 | ベースモデル別インストールバッチ（`install-LTX25.bat`等）の整備 | **実装完了（2026-08-30）・開発機ゲート A0〜A8 合格・サブマシンゲート G0〜G7 待ち。** 実ダウンロードを伴う確認だけが残っている（[`VERIFICATION_LOG.md`](VERIFICATION_LOG.md) §82） |
