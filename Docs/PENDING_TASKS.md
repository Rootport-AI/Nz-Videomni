...
- 作成: 2026-07-15／最終更新: 2026-09-16（§3-151〔バッチパネルのLTX 2.5での実機確認〕をオーナーの実機確認〔2026-09-15〕と裁定でクローズし、[`PENDING_TASKS_CLOSED.md`](PENDING_TASKS_CLOSED.md) §3-151 へ移した。現在の構成は**§3 将来の研究課題／§4 スコープ外**の2節で、§1・§2 は該当項目が無いため見出しごと削除してある）
