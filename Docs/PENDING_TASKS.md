...
- 作成: 2026-07-15／最終更新: 2026-09-02（**§3-47（バッチA2Vランナーの孤児化）を実装してクローズし、オーナー実機目視の待ち行列として§2を立て直した**。目視項目は本書§2-1、実装記録は[`PENDING_TASKS_CLOSED.md`](PENDING_TASKS_CLOSED.md) §3-47-02）
