...
- 作成: 2026-07-15／最終更新: 2026-09-02（**§3-104をクローズし、本書から除去した**——インストーラの任意フラグ`-ResolveLatest`は、直すのではなく**削除する**ことで解消した〔オーナー裁定〕。移設先は[`PENDING_TASKS_CLOSED.md`](PENDING_TASKS_CLOSED.md) §3-104）
