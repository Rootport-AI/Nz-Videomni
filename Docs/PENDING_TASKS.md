...
- **素材の置き場**: **`outputs/ltx25-rtes-gate/g8_material/`**（動画15本〔撮り直し7本・素材（末尾）8本。うち2本は素材そのもの〕・静止画の素材1枚・比較用スクリーンショット10枚。**読み方は同フォルダの`README.md`**にある）。
