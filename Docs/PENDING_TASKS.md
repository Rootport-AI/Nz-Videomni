...
- 作成: 2026-07-15／最終更新: 2026-09-02（**§3-62を実装・実機ゲート合格でクローズし、本書から除去した**。移設先は[`PENDING_TASKS_CLOSED.md`](PENDING_TASKS_CLOSED.md) §3-62-02で、**後継の研究課題として§3-141〔RetakeのIC-LoRA対応〕を起票した**）
