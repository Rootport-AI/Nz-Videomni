...
- **挿し込む画像素材は用意済み**: リポジトリ直下の`images/`に、オーナーが2026-09-03に同梱した（ロゴ・導入手順のスクリーンショット等。中身はディレクトリを直接見ること——ここへ写すと増減のたびに食い違う）。READMEからは相対パスで参照する。
