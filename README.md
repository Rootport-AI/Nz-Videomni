...
> LTX 2.5 でも使えます**（§7「制限事項」の LTX 2.5 の項。**キャンバス拡張は 2026-08-29 に
> オーナーの目視確認にも合格しました。撮り直しと素材（末尾）は目視確認がまだ済んでいません**）。
> **ネガティブプロンプト（NAG／VSF）は 2026-08-30 から LTX 2.5 でも使えます**（目視確認はまだ済んでいません）。
