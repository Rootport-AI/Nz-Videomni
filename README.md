...
> **撮り直し（Retake）と素材（末尾）は 2026-08-26 から、キャンバス拡張（Outpainting）は 2026-08-29 から
...
スタイル LoRA・IC-LoRA（参照動画による制御）と、キャンバス拡張（Outpainting）と、高速化4つ（GGUF逆量子化の1カーネル化・先読み block swap・
...
**2026-08-29、キャンバス拡張（Outpainting）も LTX 2.5 で使えるようになりました。** Edit タブの
