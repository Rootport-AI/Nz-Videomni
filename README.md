...
> LTX 2.5 でも使えます**（§7「制限事項」の LTX 2.5 の項。**ただしどちらもオーナーの目視確認がまだ
> 済んでいません**）。**LTX 2.5 でまだ使えないのは、NAG／VSF・PrunaVAED・
...
**ただし、この機能にもオーナーによる目視確認がまだ済んでいません**（[`Docs/PENDING_TASKS.md`](Docs/PENDING_TASKS.md) §2-2、
実測は [`Docs/VERIFICATION_LOG.md`](Docs/VERIFICATION_LOG.md) §79）。**使うときに1つ知っておいてください**——
