...
# nag_enabled/nag_scale/nag_tau/nag_alpha, src_audio) appended after the S6
# params — the same positional order the handler's signature declares (ui.py's
# click inputs stop at chunked_upsample/nag_alpha; src_audio is only ever
# passed positionally by this helper).
