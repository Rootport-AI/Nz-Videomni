...
from _routes.fp8_export import router as fp8_export_router
...
from _routes.qwentts import router as qwentts_router
...
def create_app(
    *,
    ...
    app.include_router(fp8_export_router)
    ...
    app.include_router(qwentts_router)
